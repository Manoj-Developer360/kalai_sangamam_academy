...
const AdminAchievements = createAdminCrudPage({
  ...
  service,
  emptyForm: { type: 'stat', label: '', value: '', year: '', description: '', display_order: 0 },
  fields: [
    { key: 'type', label: 'Type', type: 'select', options: ['stat', 'milestone'], required: true },
    { key: 'label', label: 'Label (e.g. "Schools")', type: 'text', required: true },
    { key: 'value', label: 'Value (e.g. "15+")', type: 'text', required: true },
