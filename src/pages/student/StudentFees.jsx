...
const StudentFees = () => {
  ...
  return <StudentDashboardLayout>
    ...
    {fees && <div className="grid lg:grid-cols-[1.3fr_1fr] gap-6">
      ...
      <div className="card p-6 h-fit"><div className="flex items-center gap-2 mb-4"><FiCreditCard className="text-brass-500" /><p className="font-display text-parchment-100">Online Payment</p></div>
